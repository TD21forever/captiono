...
1. Download `captiono-1.6.1.zip` from [Releases](https://github.com/TD21forever/captiono/releases/latest).
2. Unzip the archive.
3. Open `chrome://extensions` and enable **Developer mode**.
4. Click **Load unpacked** and select the extracted `captiono-1.6.1` folder.
